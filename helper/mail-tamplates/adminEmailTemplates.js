...
/* ---------------- PROVIDER SUBSCRIPTION CANCELLED EMAIL ---------------- */
function providerSubscriptionCancelledEmailTemplate({
  userName,
  planName,
  reason,
}) {
...
<body style="margin:0; padding:0; background-color:#f4f6f8; font-family:Arial, Helvetica, sans-serif; color:#1f2937;">
  ...
  <div style="max-width:720px; margin:0 auto; background-color:#ffffff;">
    ...
    <div style="padding:24px 32px 32px;">
      ...
      <p style="margin:0 0 16px; font-size:14px; line-height:1.6;">
        Your subscription to the <strong>${planName}</strong> plan has been cancelled by our administration team.
      </p>
